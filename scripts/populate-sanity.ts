...
// Define all pages with their content blocks - CORRECTED FIELD NAMES
const pages = [
  {
    _type: 'page',
    title: 'Home',
    ...
    blocks: [
      {
        ...
        subheading: 'Neither do we. Timber International delivers consistent quality timber at industrial scale—backed by dedicated account management and transparent supply chain operations.',
      ...
      },
      {
        ...
        text: 'Remove supply uncertainty from your operations. Consistent quality. Reliable delivery. Industrial capacity.',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        text: 'Download detailed spec sheets or discuss your specific requirements with our technical team.',
...
- Scalable operations to match your growth`,
      ...
      },
      {
        ...
        text: 'See our manufacturing capabilities firsthand and discuss how we can support your operations.',
...
async function populateSanity() {
  try {
    ...
    console.log(`   https://timber-international.sanity.studio\n`)
  } catch (error: any) {
