    ...
    <section id="contact" className="scroll-mt-20" aria-label="Contact">
      {data?.blocks && data.blocks.length > 0 ? (
        ...
        <div className="py-20 px-6 max-w-6xl mx-auto">
          ...
          >
            <MaterialIcon name="handshake" size="2xl" className="text-moooi-gold mb-4" />
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            >
              <MaterialIcon name="mail" size="xl" className="text-moooi-gold mb-4" />
            ...
            <motion.div
              ...
              className="text-center p-8 bg-white rounded-2xl shadow-sm"
            >
              <MaterialIcon name="call" size="xl" className="text-moooi-gold mb-4" />
            ...
            <motion.div
              ...
              className="text-center p-8 bg-white rounded-2xl shadow-sm"
            >
              <MaterialIcon name="location_on" size="xl" className="text-moooi-gold mb-4" />
